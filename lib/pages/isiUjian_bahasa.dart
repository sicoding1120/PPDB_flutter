...
class IsiujianBahasa extends StatefulWidget {
  @override
  State<IsiujianBahasa> createState() => _IsiujianBahasastate();
}

class _IsiujianBahasastate extends State<IsiujianBahasa> {
  final Color greenColor = Color(0xFF24D674);

  // Contoh data soal dan opsi
  final List<Map<String, dynamic>> soalList = [
    {
      'pertanyaan': '1. He usually.....to school by bicycle',
      'opsi': ['go', 'going', 'goes', 'gone', 'went'],
    },
