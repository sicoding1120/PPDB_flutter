...
class isiujianAgama extends StatefulWidget {
  @override
  State<isiujianAgama> createState() => _IsiujianAgamaState();
}

class _IsiujianAgamaState extends State<isiujianAgama> {
  final Color greenColor = Color(0xFF24D674);

  // Contoh data soal dan opsi
  final List<Map<String, dynamic>> soalList = [
    {
      'pertanyaan': '1. Apa Hukum Menyembah Berhala?',
