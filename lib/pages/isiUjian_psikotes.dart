...
class isiujianPsikotes extends StatefulWidget {
  @override
  State<isiujianPsikotes> createState() => _IsiujianPsikotesState();
}

class _IsiujianPsikotesState extends State<isiujianPsikotes> {
  final Color greenColor = Color(0xFF24D674);

  // Contoh data soal dan opsi
  final List<Map<String, dynamic>> soalList = [
    {
      'pertanyaan': '1. Mata:melihat, Telinga:?',
      'opsi': ['Mendengar', 'Berbicara', 'Mencium', 'Meraba', 'Mengendus'],
